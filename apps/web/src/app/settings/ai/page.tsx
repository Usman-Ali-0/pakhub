...
const AI_PROVIDERS = [
  ...
  { id: 'google', name: 'Google AI', models: ['gemini-2.5-pro', 'gemini-2.5-flash', 'gemini-2.0-flash'], color: '#4285f4', desc: 'Gemini 2.5 Pro, Gemini 2.5 Flash' },
  { id: 'groq', name: 'Groq', models: ['llama-3.3-70b-versatile', 'mixtral-8x7b-32768'], color: '#f97316', desc: 'Llama 3.3, Mixtral — blazing fast' },
